...
function Card({ card_title, card_paragraph, card_image }) {
  return (
    <>
      <div className="w-1/3 shadow-sm shadow-primary text-center flex flex-col items-center bg-white rounded py-10 px-5 justify-evenly hover:shadow-md hover:shadow-primary">
